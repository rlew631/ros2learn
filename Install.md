### Get the code
```
cd ~ && git clone -b master https://github.com/kkonen/ros2learn.git
cd ros2learn
...
- **gym-gazebo2**: is a toolkit for developing and comparing reinforcement learning algorithms using ROS 2 and Gazebo. Follow the [instructions](https://github.com/kkonen/gym-gazebo2/blob/phantomx/INSTALL.md) to install it.
